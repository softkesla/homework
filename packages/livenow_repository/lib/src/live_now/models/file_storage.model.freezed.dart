...
mixin _$FileStorage {
  ...
  Map<String, FileStorageFormat>? get formats =>
    ...
    return _then(_value.copyWith(
      ...
      formats: freezed == formats
          ...
          : formats // ignore: cast_nullable_to_non_nullable
              as Map<String, FileStorageFormat>?,
...
class _$_FileStorage implements _FileStorage {
  const _$_FileStorage(
      ...
      this.size,
      this.url,
      final Map<String, FileStorageFormat>? formats,
      this.provider,
      this.width,
      this.height,
  ...
  @override
  final String? url;
  final Map<String, FileStorageFormat>? _formats;
  @override
  Map<String, FileStorageFormat>? get formats {
  ...
  @override
  String toString() {
    return 'FileStorage(name: $name, alternativeText: $alternativeText, caption: $caption, hash: $hash, ext: $ext, mime: $mime, size: $size, url: $url, formats: $formats, provider: $provider, width: $width, height: $height, related: $related, createdAt: $createdAt, updatedAt: $updatedAt, id: $id)';
  }
...
abstract class _FileStorage implements FileStorage {
  const factory _FileStorage(
      ...
      final DateTime? createdAt,
      final DateTime? updatedAt,
      final String? id}) = _$_FileStorage;
