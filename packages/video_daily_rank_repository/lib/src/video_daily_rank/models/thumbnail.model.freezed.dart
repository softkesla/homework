...
mixin _$Thumbnail {
  ...
  Map<String, VideoFormats>? get formats => throw _privateConstructorUsedError;
...
class _$_Thumbnail implements _Thumbnail {
  const _$_Thumbnail(
      ...
      this.size,
      this.url,
      final Map<String, VideoFormats>? formats,
      this.provider,
      this.width,
      this.height,
  ...
  @override
  final String? url;
  final Map<String, VideoFormats>? _formats;
  @override
  Map<String, VideoFormats>? get formats {
  ...
  @override
  String toString() {
    return 'Thumbnail(name: $name, alternativeText: $alternativeText, caption: $caption, hash: $hash, ext: $ext, mime: $mime, size: $size, url: $url, formats: $formats, provider: $provider, width: $width, height: $height, related: $related, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
abstract class _Thumbnail implements Thumbnail {
  const factory _Thumbnail(
      ...
      final List<String>? related,
      final String? createdAt,
      final String? updatedAt}) = _$_Thumbnail;
