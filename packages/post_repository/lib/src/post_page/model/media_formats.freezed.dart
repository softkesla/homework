...
class _$_MediaFormats implements _MediaFormats {
  ...
  @override
  String toString() {
    return 'MediaFormats(name: $name, hash: $hash, ext: $ext, mime: $mime, width: $width, height: $height, size: $size, path: $path, url: $url)';
  }
...
abstract class _MediaFormats implements MediaFormats {
  factory _MediaFormats(
      ...
      final double? size,
      final String? path,
      final String? url}) = _$_MediaFormats;
