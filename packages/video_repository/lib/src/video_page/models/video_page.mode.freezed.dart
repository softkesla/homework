...
VideoPageModel _$VideoPageModelFromJson(Map<String, dynamic> json) {
  return _VideoPageModel.fromJson(json);
}
...
mixin _$VideoPageModel {
  ...
  @JsonKey(ignore: true)
  $VideoPageModelCopyWith<VideoPageModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $VideoPageModelCopyWith<$Res> {
  factory $VideoPageModelCopyWith(
          VideoPageModel value, $Res Function(VideoPageModel) then) =
      _$VideoPageModelCopyWithImpl<$Res, VideoPageModel>;
  @useResult
  $Res call(
      {String? status,
      String? type,
...
/// @nodoc
class _$VideoPageModelCopyWithImpl<$Res, $Val extends VideoPageModel>
    implements $VideoPageModelCopyWith<$Res> {
  _$VideoPageModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_VideoPageModelCopyWith<$Res>
    implements $VideoPageModelCopyWith<$Res> {
  factory _$$_VideoPageModelCopyWith(
          _$_VideoPageModel value, $Res Function(_$_VideoPageModel) then) =
      __$$_VideoPageModelCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String? status,
...
/// @nodoc
class __$$_VideoPageModelCopyWithImpl<$Res>
    extends _$VideoPageModelCopyWithImpl<$Res, _$_VideoPageModel>
    implements _$$_VideoPageModelCopyWith<$Res> {
  __$$_VideoPageModelCopyWithImpl(
      _$_VideoPageModel _value, $Res Function(_$_VideoPageModel) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_VideoPageModel(
      status: freezed == status
          ? _value.status
          : status // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$_VideoPageModel implements _VideoPageModel {
  ...
  factory _$_VideoPageModel.fromJson(Map<String, dynamic> json) =>
      _$$_VideoPageModelFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_VideoPageModelCopyWith<_$_VideoPageModel> get copyWith =>
      __$$_VideoPageModelCopyWithImpl<_$_VideoPageModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_VideoPageModelToJson(
      this,
    );
  }
}

abstract class _VideoPageModel implements VideoPageModel {
  const factory _VideoPageModel(
      ...
      final DateTime? createdAt,
      final DateTime? updatedAt,
      final String? orientation}) = _$_VideoPageModel;

  factory _VideoPageModel.fromJson(Map<String, dynamic> json) =
      _$_VideoPageModel.fromJson;
