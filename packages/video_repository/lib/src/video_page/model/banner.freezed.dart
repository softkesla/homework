...
class _$_Banner implements _Banner {
  ...
  @override
  String toString() {
    return 'Banner(size: $size, ext: $ext, width: $width, caption: $caption, height: $height, related: $related, name: $name, hash: $hash, updatedAt: $updatedAt, url: $url, provider: $provider, mime: $mime, v: $v, id: $id, alternativeText: $alternativeText, createdAt: $createdAt, formats: $formats)';
  }
...
abstract class _Banner implements Banner {
  factory _Banner(
      ...
      final String? alternativeText,
      final DateTime? createdAt,
      final FormatsThumbnail? formats}) = _$_Banner;
