...
class _$_Thumbnail implements _Thumbnail {
  ...
  @override
  String toString() {
    return 'Thumbnail(size: $size, ext: $ext, width: $width, caption: $caption, height: $height, name: $name, createdBy: $createdBy, hash: $hash, updatedAt: $updatedAt, url: $url, provider: $provider, mime: $mime, id: $id, alternativeText: $alternativeText, createdAt: $createdAt, updatedBy: $updatedBy)';
  }
