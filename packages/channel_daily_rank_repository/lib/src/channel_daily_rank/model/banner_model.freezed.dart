...
class _$_Banner implements _Banner {
  ...
  @override
  String toString() {
    return 'Banner(size: $size, ext: $ext, width: $width, caption: $caption, height: $height, name: $name, createdBy: $createdBy, hash: $hash, updatedAt: $updatedAt, url: $url, provider: $provider, mime: $mime, sId: $sId, alternativeText: $alternativeText, createdAt: $createdAt, updatedBy: $updatedBy, formats: $formats)';
  }
...
abstract class _Banner implements Banner {
  const factory _Banner(
      ...
      final DateTime? createdAt,
      final String? updatedBy,
      final Formats? formats) = _$_Banner;
