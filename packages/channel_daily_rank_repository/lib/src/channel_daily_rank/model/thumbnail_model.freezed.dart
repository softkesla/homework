...
class _$_Thumbnails implements _Thumbnails {
  ...
  @override
  String toString() {
    return 'Thumbnails(size: $size, ext: $ext, width: $width, caption: $caption, height: $height, name: $name, createdBy: $createdBy, hash: $hash, updatedAt: $updatedAt, url: $url, provider: $provider, mime: $mime, sId: $sId, alternativeText: $alternativeText, createdAt: $createdAt, updatedBy: $updatedBy)';
  }
...
abstract class _Thumbnails implements Thumbnails {
  const factory _Thumbnails(
      ...
      final String? alternativeText,
      final DateTime? createdAt,
      final String? updatedBy) = _$_Thumbnails;
