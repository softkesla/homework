...
class _$_FormatsThumbnail implements _FormatsThumbnail {
  const _$_FormatsThumbnail(this.size, this.ext, this.path, this.width,
      this.height, this.name, this.hash, this.url, this.mime);
  ...
  @override
  String toString() {
    return 'FormatsThumbnail(size: $size, ext: $ext, path: $path, width: $width, height: $height, name: $name, hash: $hash, url: $url, mime: $mime)';
  }
...
abstract class _FormatsThumbnail implements FormatsThumbnail {
  const factory _FormatsThumbnail(
      ...
      final String? hash,
      final String? url,
      final String? mime) = _$_FormatsThumbnail;
