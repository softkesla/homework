...
class _$_Thumbnail implements _Thumbnail {
  ...
  @override
  String toString() {
    return 'Thumbnail(id: $id, name: $name, alternativeText: $alternativeText, caption: $caption, hash: $hash, ext: $ext, mime: $mime, size: $size, url: $url, formats: $formats, provider: $provider, width: $width, height: $height, related: $related, createdAt: $createdAt, updatedAt: $updatedAt, v: $v, createdBy: $createdBy, updatedBy: $updatedBy)';
  }
...
abstract class _Thumbnail implements Thumbnail {
  factory _Thumbnail(
      ...
      @JsonKey(name: 'updated_by') final String? updatedBy}) = _$_Thumbnail;
